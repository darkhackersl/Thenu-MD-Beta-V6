...
async function loadData() {
    try {
        ...
        // Load premium JIDs
        const premiumResponse = await axios.get("https://raw.githubusercontent.com/darkhackersl/Thenu-MD-V2/refs/heads/main/lib/premium.json").catch(err => {
        ...
        // Load developer JIDs
        const developerResponse = await axios.get("https://raw.githubusercontent.com/darkhackersl/Thenu-MD-V2/refs/heads/main/lib/premium.json").catch(err => {
