...
async (conn, mek, m, { from, quoted, body, q, reply }) => {
    ...
    try {
        ...
        await conn.sendMessage(
            from,
            { document: buff, caption: `> *©ᴘᴏᴡᴇʀᴇᴅ ʙʏ Thenux ᴛᴇᴄʜ*\n\n*We will fix showing File name later*`, mimetype: "application/vnd.android.package-archive", filename: `${appInfo.appname}.apk` },
            { quoted: mek }
        );
